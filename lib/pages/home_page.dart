...
//     //     //   debugPrint(this.datasToUpload.length);
...
//     //     //       debugPrint("\nIS END ... ");
//     //     //       debugPrint(datasToUpload.length == datasUploaded);
...
//     //   child: BlocBuilder<DataCollectedBloc, DataCollectedState>(
...
//     //         this.datas = state.data;
//     //       }
//     return BlocBuilder<DataCollectedBloc, DataCollectedState>(
//       builder: (BuildContext context, DataCollectedState state) {
//         print('\nLIST DATA STTATE -- $state');

//         // dataBloc = context.bloc<DataBloc>(); // 
//         // dataBloc = BlocProvider.of<DataCollectedBloc>(context);
...
//         } else if (state is DataCollectedLoadSuccess) {
...
//               debugPrint("\nGET THE PROJECT...");
//               debugPrint(Project.instance.toJson().toString());
...
//       ),
//     ).then((onValue) {
//       this._dataCollectedBloc.add(DataCollectedLoad());
//     });
//   }
...
//             if (isDeleted) {
//               _dataCollectedBloc.add(DataCollectedDeleted(data));
//             }
//           },
//         ),        
//       ],
